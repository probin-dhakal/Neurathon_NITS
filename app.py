...
def start_debate():
    ...
    bot_response = f"Thank you for starting the debate on '{topic}'. You are arguing {role}. I will present my counter-argument shortly."
...
def send_message():
    ...
    bot_response = f"Interesting point! Could you elaborate more on '{user_message}'?"  # You can replace this with AI logic
    conversation_history.append(("Bot", bot_response))
...
def end_debate():
    conversation_history.append(("System", "Debate has ended."))
